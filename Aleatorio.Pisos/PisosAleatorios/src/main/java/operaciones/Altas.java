...
public class Altas {
    ...
    public static int addPiso(File fichero, int numRegs, Scanner input) throws IOException {
        ...
        do {
            ...
            switch(op){
                case 1:
                    piso = altaAtico(input);
                    break;
                case 2:
                    piso = altaDuplex(input);
                    break;
                case 0:
    ...
    public static Piso altaAtico(Scanner input) {
    ...
    public static Piso altaDuplex(Scanner input) {
